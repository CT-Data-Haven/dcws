...
This is a small data-focused package to make easier use of the DataHaven Community Wellbeing Survey. It contains the data extracted from crosstabs from the `r knitr::combine_words(unique(cws_full_data$year))` survey waves. 2020, 2022, and 2025 are statewide only.
