...
check-release](https://img.shields.io/github/actions/workflow/status/CT-Data-Haven/dcws/check-release.yaml?style=flat-square&label=check-release)![GitHub
Actions Workflow Status:
pkgdown](https://img.shields.io/github/actions/workflow/status/CT-Data-Haven/dcws/pkgdown.yaml?style=flat-square&label=pkgdown)![Codecov](https://img.shields.io/codecov/c/github/CT-Data-Haven/dcws?style=flat-square.png)
...
crosstabs from the survey waves. 2020, 2022, and 2025 are statewide
only.
