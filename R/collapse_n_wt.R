...
#' @return A data frame with summarized values. The column specified in `.group` will have
#' the collapsed groups, and the column specified in `.value` will have average values.
#' @examples
